module github.com/LeoBorquez/workiBack

go 1.14

require (
	fyne.io/fyne v1.3.3 // indirect
	gioui.org v0.0.0-20201030154705-ef652f4922e0 // indirect
	...
	github.com/ajstarks/deck/generate v0.0.0-20200831202436-30c9fc6549a9 // indirect
